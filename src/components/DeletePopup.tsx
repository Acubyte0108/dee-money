...
const DeletePopup = (props: DeletePopupProps) => {
  ...
  return (<div className="fixed bg-gray-800 bg-opacity-75 inset-0 flex items-center justify-center z-10" onClick={toggle}>
            <div className="bg-white p-6 rounded-xl shadow-lg sm:w-[450px] sm:h-[450px] mx-auto" onClick={(e: React.MouseEvent<HTMLDivElement, MouseEvent>) => e.stopPropagation()}>
                <div className="flex flex-col justify-end items-center h-full">
                  <div className="">
                  <IconContext.Provider value={{ className:"text-amber-500" ,size: "8rem" }} >
                    <PiWarningBold />
                  ...
                  <div className="flex flex-col justify-center items-center py-6 gap-y-3 border-b-2 border-b-slate-300 w-full">
                    ...
                    <div className="text-xl font-medium">{userData.firstName} {userData.lastName}</div>
                  </div>
